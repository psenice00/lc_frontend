                    ...
                    <Fragment>
                        {writersState.writer ? (
                            <div className=" pl-0 pl-xl-4  mt-3">
                                <div className="d-flex justify-content-left align-items-start align-items-md-center mb-5 ml-0 ml-md-4 ml-lg-5  pl-0 pl-lg-5">
                                    <Image className="authorImg rounded  mt-2 mt-md-0" src={writersState.writer.imageUrl} />
                        ...
                        ) : (<div className=" pl-0 pl-xl-4  mt-3"><h2 className="text-center text-md-left mb-5 ml-0 ml-md-4 ml-lg-5  pl-0 pl-lg-5 ">Seznam knih</h2></div>)}
